 ...
 * `FileText` icon in a periwinkle circle, a heading, a description,
 ...
 * same outer layout, periwinkle circle, `FileText` icon, and font
 ...
 *
 * Reuses the periwinkle circle, FileText icon, and font tokens from
 ...
 * an "Import all" pill button reusing the same periwinkle classes.
 *
  ...
  return (
    <div className="flex flex-col items-center py-20 text-center px-6">
      ...
      <button
        ...
        className="inline-flex items-center justify-center bg-periwinkle hover:bg-periwinkle-hover text-charcoal font-heading font-semibold text-sm uppercase tracking-wider rounded-full px-5 py-2 transition-colors disabled:opacity-40"
      >
